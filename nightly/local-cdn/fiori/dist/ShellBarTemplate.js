...
export default function ShellBarTemplate() {
    return (_jsxs(_Fragment, { children: [_jsxs("header", { class: this.classes.wrapper, "aria-label": this._shellbarText, onKeyDown: this._onKeyDown, part: "root", children: [_jsxs("div", { class: "ui5-shellbar-overflow-container ui5-shellbar-overflow-container-left", children: [this.startButton.length > 0 && _jsx("slot", { name: "startButton" }), this.hasMenuItems && (_jsxs(_Fragment, { children: [!this.showLogoInMenuButton && this.hasLogo && singleLogo.call(this), this.showTitleInMenuButton && _jsx("h1", { class: "ui5-hidden-text", children: this.primaryTitle }), this.showMenuButton && (_jsxs(_Fragment, { children: [_jsxs("button", { class: {
                                            ...
                                            return (_jsxs("div", { id: item._individualSlot, class: itemInfo?.classes, "data-hide-order": `${item.getAttribute("data-hide-order")}`, children: [this.shouldIncludeSeparator(itemInfo, this.startContentInfoSorted) && (
                                            ...
                                            const itemInfo = this._contentInfo.find(info => info.id === item._individualSlot);
                                            return (_jsxs("div", { id: item._individualSlot, class: itemInfo?.classes, "data-hide-order": item.getAttribute("data-hide-order"), children: [_jsx("slot", { name: item._individualSlot }), this.shouldIncludeSeparator(itemInfo, this.endContentInfoSorted) && (
                                                    // never displayed, only "packed" with last item that was hidden, used for measurement purposes
                                                    _jsx("div", { class: {
                                                            "ui5-shellbar-separator": true,
